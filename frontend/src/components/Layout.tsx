    ...
    return (
        <>
            ...
            <div className="flex-1 flex flex-col min-w-0">
                {/* Top Header */}
                <header className="h-16 bg-[var(--bg-soft)] flex items-center justify-between px-4 sm:px-8">
                ...
                {/* Page Content */}
                <main className="flex-1 overflow-y-auto p-4 sm:p-6 bg-[var(--bg-primary)] flex flex-col relative">
                    {children}
                </main>
            </div>
        </div>
